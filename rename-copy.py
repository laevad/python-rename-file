...
letter = "D"
input_path = "E:/CROPPED/cropped silt/" + letter + "-SILT"
output_path = 'E:/CROPPED/cropped silt/CROPPEDSILT'
...
for i, file in enumerate(files):
    ...
    if file.endswith(allowed_extensions):
        ...
        new_name = 'image_' + letter + '_{:03d}{}'.format(i, os.path.splitext(file)[1])
